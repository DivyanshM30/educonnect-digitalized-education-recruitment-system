    ...
    <div className="container" style={{ backgroundImage: "url(/BG1.JPG)" }}>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Welcome to <br> Educonnect <br> Digitalized Education and Recruitment System: Where Learning Meets Opportunity</h1>
      ...
      <footer className="footer">
        ...
        <div className="social-links">
          <a href="https://www.linkedin.com/in/divyanshm30/?originalSubdomain=in">LinkedIn</a>
          <a href="#">Twitter</a>
          <a href="#">Facebook</a>
        </div>
      </footer>
